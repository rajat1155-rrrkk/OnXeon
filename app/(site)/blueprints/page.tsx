  ...
  return (
    <Section>
      <div className="relative mx-auto max-w-6xl space-y-10 py-24">
        ...
        <div className="group premium-soft-card chrome-hover relative mx-auto max-w-3xl space-y-4 overflow-hidden rounded-2xl border border-border/70 bg-gradient-to-b from-card via-card/96 to-card/90 p-8 text-center transition-all duration-500 hover:shadow-xl hover:shadow-brand/20 premium-dropdown-shell">
          ...
          <div>
            <Link
              href="/contact#book"
              className="premium-soft-card chrome-hover inline-flex items-center gap-1.5 rounded-full border border-brand/30 bg-brand/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.08em] text-foreground transition-all duration-300 hover:-translate-y-px hover:border-brand/55 hover:bg-brand/16 hover:text-brand hover:shadow-[0_0_16px_hsl(var(--brand)/0.24)]"
            >
              See Xeon Outcomes
            </Link>
          </div>
