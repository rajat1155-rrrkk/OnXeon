              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-4 inline-flex items-center text-xs font-semibold text-foreground">
                    View details
                    <span className="ml-1 transition-transform duration-300 group-active:translate-x-1">→</span>
                  </div>
                </div>
              </Link>
            ))}
                  ...
                  {[
                    ...
                    >
                      ...
                      <img
                        ...
                        className="relative z-10 h-4 w-4 rounded-sm object-contain transition-transform duration-500 group-hover/item:scale-110 group-hover/item:-rotate-2 sm:h-5 sm:w-5"
                        loading="lazy"
                      />
                      <span className="relative z-10 text-xs font-medium transition-all duration-300 group-hover/item:text-foreground group-hover/item:tracking-[0.01em] sm:text-sm">
                        {platform.name}
                      </span>
                    </Link>
                  ))}
